  ...
  Future<void> _cargarDatosYProcesarMetric() async {
    try {
      ...
      for (var doc in snapshot.docs) {
        ...
        conteoMaterias[nombreCorto] =
            (conteoMaterias[nombreCorto] ?? 0) + numInscritos;
      }
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: SizedBox(
          ...
          child: todosCero
              ? const Center(
                  child: Text('Sin datos registrados en la plataforma'),
                )
              : PieChart(
                  PieChartData(
                    sectionsSpace: 2,
        ...
        child: SizedBox(
          ...
          child: BarChart(
            BarChartData(
              ...
              maxY:
                  (_materiasSolicitadas.values.isEmpty
                          ? 1
                          : _materiasSolicitadas.values.reduce(
                                  (a, b) => a > b ? a : b,
                                ) +
                                2)
                      .toDouble(),
