...
class _PerfilPublicoTutorViewState extends State<PerfilPublicoTutorView> {
    ...
    try {
      ...
      final snapTutorias = await FirebaseFirestore.instance
          ...
          .where(
            ...
            isEqualTo: widget.mentor.identificadorUnico,
          )
  ...
  Widget build(BuildContext context) {
    ...
    if (miIdentidad?.rolEnElSistema == RolSistema.estudiante &&
        widget.mentor.rolEnElSistema == RolSistema.estudiante) {
      return Scaffold(
        appBar: AppBar(
    ...
    final esAdmin =
        miIdentidad?.rolEnElSistema.toString() == "RolSistema.admin";
    final yaSuscrito =
        miIdentidad?.listaDeTutoresSuscritos.contains(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  CircleAvatar(
                    radius: 50,
                    backgroundColor: esTutor
                        ? AppTheme.primarioVerde.withValues(alpha: 0.2)
                        : Colors.grey.shade200,
                    child: Icon(
                      Icons.person,
                      size: 60,
                      color: esTutor ? AppTheme.primarioVerde : Colors.grey,
                    ),
                  ),
                  const SizedBox(height: 16),
                  Text(
                  ...
                  Text(
                    widget.mentor.carrera ??
                        widget.mentor.facultad ??
                  ...
                  Row(
                    ...
                    children: [
                      if (_calculandoStats && esTutor)
                        ...
                        _construirMetrica(
                          esTutor ? _totalTutoriasDictadas.toString() : '0',
                          'Tutorías',
                          Icons.history_edu,
                        ),
                      ],
            ...
            if (esTutor ||
                widget.mentor.descripcionPerfil?.isNotEmpty == true) ...[
              Container(
                width: double.infinity,
                color: Theme.of(context).colorScheme.surface,
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      esTutor ? 'Sobre mí' : 'Sobre el usuario',
                      style: const TextStyle(
                        fontSize: 18,
                        fontWeight: FontWeight.bold,
                      ),
                    ...
                    Text(
                      widget.mentor.descripcionPerfil ??
                          'Este perfil no cuenta con una descripción pública aún.',
                ...
                children: [
                  ...
                  ListTile(
                    ...
                    leading: const CircleAvatar(
                      ...
                      child: Icon(Icons.email, color: AppTheme.primarioAzul),
                    ),
                    title: const Text(
                    ...
                    subtitle: Text(
                      widget.mentor.correoElectronico,
                      style: const TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 16,
                      ),
                  ...
                  ListTile(
                    ...
                    leading: const CircleAvatar(
                      ...
                      child: Icon(Icons.phone, color: AppTheme.primarioVerde),
                    ),
                    title: const Text(
                      'Teléfono Personal',
                      style: TextStyle(color: Colors.grey, fontSize: 13),
                    ...
                    subtitle: Text(
                      widget.mentor.telefonoPersonal ??
                          'No provisto al público',
                      style: const TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 16,
                      ),
                    ...
                    StreamBuilder<QuerySnapshot>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                          return const Text(
                            "Este tutor aún no tiene valoraciones.",
                            style: TextStyle(
                              color: Colors.grey,
                                        ...
                                        try {
                                          ...
                                          if (ctx.mounted) {
                                            ScaffoldMessenger.of(
                                              ...
                                              const SnackBar(
                                                content: Text(
                                                  'Error al eliminar comentario: permisos insuficientes',
                                                ),
    ...
    await showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            const Text(
              "Si sufriste alguna falta de respeto, ausencia o comportamiento inapropiado, descríbelo aquí. Esto será investigado de manera anónima por el Tribunal de VECTA.",
            ),
            const SizedBox(height: 16),
            TextField(
              controller: txtQueja,
            ...
            onPressed: () async {
              ...
              if (ctx.mounted) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text(
                      "Queja enviada al Tribunal. Gracias por tu reporte.",
                    ),
